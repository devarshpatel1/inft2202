...
function list(recordPage) {
    ...
    function createPagination(pagination) {
        ...
        prevLi.innerHTML = `<a class="page-link" href="./list.html?page=${pagination.page - 1}">Previous</a>`;
        ...
        for (let i = 1; i <= pagination.pages; i++) {
            ...
            li.innerHTML = `<a class="page-link" href="./list.html?page=${i}">${i}</a>`;
            ul.appendChild(li);
        }
        ...
        nextLi.innerHTML = `<a class="page-link" href="./list.html?page=${pagination.page + 1}">Next</a>`;
